...
const styles = StyleSheet.create({
  ...
  tag: { backgroundColor: 'rgba(255,255,255,0.07)', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  tagActive: { backgroundColor: Colors.primary },
  tagText: { color: 'rgba(255,255,255,0.6)', fontSize: 13, fontWeight: '600' },
